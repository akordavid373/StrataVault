...
gh issue create --title "🔄 Add WebSocket Support for Real-Time Asset Updates" --body "Currently, the backend only supports REST API calls. Users need real-time updates for:^
...
**Priority:** High^
**Labels:** enhancement,backend,websocket,real-time" --label "enhancement" --label "backend" --label "websocket" --label "real-time" --label "good first issue"
...
**Priority:** Medium^
**Labels:** enhancement,backend,logging,monitoring" --label "enhancement" --label "backend" --label "logging" --label "monitoring"
...
**Priority:** High^
**Labels:** enhancement,frontend,wallet,ux" --label "enhancement" --label "frontend" --label "wallet" --label "ux" --label "good first issue"
...
**Priority:** High^
**Labels:** enhancement,frontend,mobile,pwa" --label "enhancement" --label "frontend" --label "mobile" --label "pwa"
